...
class GslobeTranslator(Translator):
    ...
    def translate(self, query, source_language, target_language, max_translations=1):
        ...
        # Construct url
        api_url = GslobeTranslator.build_url(query, source_language, target_language)
    ...
    def build_url(query, source_language, target_language):
        ...
        return GslobeTranslator.API_BASE_URL + urllib.urlencode(query_params)
